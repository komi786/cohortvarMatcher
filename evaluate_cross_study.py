...
from src.utils import clean_label_remove_temporal_context, setup_logger , canonical_var_key
...
if __name__ == "__main__":
    ...
    ground_truth_file = base_dir / "ground_truth_pairs.xlsx"
    cohorts_dir = base_dir / "cross_mapping_article_data"
